        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-2">
            <div class="d-flex flex-column justify-content-center gap-2 gap-sm-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-t"><b>Editar Usuario</b>
                    </li>
                </ol>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 row">
                                            ...
                                            <div class="form-group col-lg-4 mb-3">
                                                ...
                                                <div class="text-danger" v-if="!$v.usuario.cod_rol.$model && $v.usuario.cod_rol.$dirty">Seleccione un rol</div>
                                            </div>
                                            <div class="form-group col-lg-4 mb-3">
                                                <span class="text-danger">*</span>
                                            ...
                                            <div class="form-group col-lg-4 mb-3">
                                                ...
                                                <input type="text" autocomplete="off" id="telefono" name="telefono" class="form-control" placeholder="Introduzca número de celular"
...
<script>
    ...
    export default{
        ...
        computed: {
             ...
             */
            textoBoton() {
                return this.cargando ? 'Actualizando' : 'Actualizar';
            },
            /**
        ...
        methods:{
             ...
             quitarImagen() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        // Si el usuario confirma, se hace la petición para quitar la imagen
                        axios({
                            method: 'POST',
                            url: `/api/usuario/quitar-imagen/${me.$route.params.id}`,
                            headers: {
                                'Authorization': `Bearer ${me.usuarioActual.token}`,
                            },
                        }).then(function (response) {
                            me.cargando = false;
                            me.usuario.foto = '/imagenes/usuarios/default.png';
                            me.$noty.success(response.data.message, {
                                theme: 'metroui',
                                killer: true,
                                timeout: 3000,
                                layout: 'bottomRight'
            ...
            preparaFormulario() {
                ...
                axios({
                    ...
                    url: `/api/usuario/editar/${me.$route.params.id}`
                }).then((response) => {
                    me.loader  = false;
                    me.roles   = response.data.roles.map((rol) => { return {
                                        value: rol.cod_rol,
                    ...
                    me.usuario.foto    = `/imagenes/usuarios/${me.usuario.foto}`;
                    // Seleccionar el rol por defecto del usuario
                    if (me.usuario.cod_rol) {
                        me.usuario.cod_rol = me.roles.find(role => role.value === me.usuario.cod_rol);
                    }
                }).catch(function (error) {
                    // console.log(error);
                    me.loader = false;
            ...
            actualizarRegistro(){
                ...
                axios({
                    method:'POST',
                    url: `/api/usuario/actualizar/${me.$route.params.id}`,
                    headers: {
                        'Authorization': `Bearer ${me.usuarioActual.token}`,
