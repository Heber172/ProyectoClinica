        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-2">
            <div class="d-flex flex-column justify-content-center gap-2 gap-sm-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-t"><b>Editar Rol</b>
                    </li>
                </ol>
            </div>
        </div>
        ...
        methods:{
            ...
            preparaFormulario() {
                ...
                axios({
                    ...
                    url: `/api/rol/editar/${me.$route.params.id}`
                }).then((response) => {
                    me.loader          = false;
                    me.permisos        = response.data.permisos;
                    me.rol.descripcion = response.data.rol.descripcion;
                    me.rol.permisos    = response.data.rol.permisos.map(el=>el.cod_permiso);
            ...
            actualizarRegistro(){
                ...
                axios({
                    method:'put',
                    url: `/api/rol/actualizar/${me.$route.params.id}`,
                    headers: {
                        'Authorization': `Bearer ${me.usuarioActual.token}`
                    },
                    data: {
                        descripcion: me.rol.descripcion,
                        permisos: me.rol.permisos
                    }
